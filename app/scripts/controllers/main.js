...
//    $rootScope.selfPath = 'http://192.168.42.1:9000';
//    $rootScope.httpPath = 'http://192.168.42.1:8282';
//    $rootScope.apiPath = 'https://192.168.42.1:3000';
    ...
    $scope.setFilePreviewId = function (fileId){
      $rootScope.previewId = fileId;
      $rootScope.groupId = $scope.currentGroup._id;
    };
    ...
    $scope.processFile = function (file){
      if(file.isDirectory || file.isDirectory === undefined){
        ...
        $scope.setFilePreviewId(file._id);
        var previewSite = $rootScope.isMobile ? $rootScope.selfPath + '/#/mobile/preview' : $rootScope.selfPath + '/#/preview';
        window.location.href = previewSite;
        $log.log(window.location);
      }
    };
  }]);